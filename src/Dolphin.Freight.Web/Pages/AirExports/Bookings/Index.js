...
$(function () {
    ...
    var queryListFilter = function () {
        return {
            ...
            bookingDate: $("#BookingDate").val() == '' || $("#BookingDate").val() == null ? null : new Date($("#BookingDate").val()),
                ...
                [
                    ...
                    },
                    {
                        ...
                        action: function (data) {
                            ...
                            location.href = 'Create?Id=' + data.record.id+'&IsCopy=true';
                            ...
                            if (!data.record.isLocked) {
                                abp.message.confirm(l('DeletionConfirmationMessage'))
                                    .then(function (confirmed) {
                                        if (confirmed) {
                                            dolphin.freight.importExport.airExports.bookings.exportBooking
                                                .deleteAirExportBooking(data.record.id)
                                                .then(function () {
    ...
    dolphin.freight.web.controllers.configuration.getJsonConfig('AirExportBookingList').done(function (data) {
        ...
        dataTable = $('#MblListTable').DataTable(
            abp.libs.datatables.normalizeConfiguration({
                ...
                scrollX: true,
                processing: true,
                ajax: abp.libs.datatables.createAjax(dolphin.freight.importExport.airExports.bookings.exportBooking.getQueryList, queryListFilter),
                columnDefs: columns
            })
        );
    })
...
var AirExports = {
    ...
    createNew: function () {
        window.location.href = '/AirExports/Bookings/Create';
    }
} 

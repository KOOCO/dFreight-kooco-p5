...
namespace Dolphin.Freight.Web.Pages.AirImports
{
    public class MawbListModel : PageModel
    {
        ...
        public MawbListModel(ISubstationAppService substationAppService, ITradePartnerAppService tradePartnerAppService, IAjaxDropdownAppService ajaxDropdownAppService,

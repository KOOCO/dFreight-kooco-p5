...
namespace Dolphin.Freight.Web.Pages.OceanExports
{
    public class MblListModel : PageModel
    {
        ...
        public MblListModel(ISubstationAppService substationAppService, ITradePartnerAppService tradePartnerAppService, IAjaxDropdownAppService ajaxDropdownAppService,
